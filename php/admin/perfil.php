...
<body>
    ...
    <div class="container">
        <br><br><br>
        <button class="btn btn-primary"><a href="logint.php" style="color: #fff;">Actualizar Información + </a></button><br>
    ...
    <div class="container">
        ...
        <button class="btn btn-primary"><a href="crear.php" style="color: #fff;">Agregar Servicios + </a></button><br>
