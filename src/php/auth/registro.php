...
<h1 class="display-4">Con nuestro sistema web, <br><b>¡tu inmueble siempre en buen estado!</b></h1><br>
    <div class="container">
        <br>
        <form class="form-register" action="../auth/validaregistro.php" method="POST">
            <div class="text">
                <h4 style="font-size: 30px; margin-top: 20px;"><font color="#F2DA63;">Registro usuarios</font></h4>
            </div><br>
